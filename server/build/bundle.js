...
var fetchUsersAction = exports.fetchUsersAction = function fetchUsersAction() {
    return function () {
            ...
            return regeneratorRuntime.wrap(function _callee2$(_context2) {
                while (1) {
                    switch (_context2.prev = _context2.next) {
                        case 0:
                            _context2.next = 2;
                            return api.get('/current_user').then(function (response) {
                                dispatch({
...
var fetchAdminsAction = exports.fetchAdminsAction = function fetchAdminsAction() {
    return function () {
            ...
            return regeneratorRuntime.wrap(function _callee3$(_context3) {
                while (1) {
                    switch (_context3.prev = _context3.next) {
                        case 0:
                            _context3.next = 2;
                            return api.get('/admins').then(function (response) {
                                dispatch({
                                    type: FETCH_ADMINS,
                                    payload: response
                                });
...
var loadData = function loadData(store) {
    return store.dispatch((0, _actions.fetchUsersAction)());
};
exports.default = {
    loadData: loadData,
    component: (0, _reactRedux.connect)(mapStateToProps, { fetchUsersAction: _actions.fetchUsersAction })(UsersList)
};
...
exports.default = {
    component: (0, _reactRedux.connect)(mapStateToProps, { fetchAdminsAction: _actions.fetchAdminsAction })((0, _requireAuth2.default)(AdminsListPage)),
    loadData: function loadData(_ref2) {
        var dispatch = _ref2.dispatch;
        return dispatch((0, _actions.fetchAdminsAction)());
    }
};
