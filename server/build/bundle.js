...
exports.fetchUsersAction = exports.ERROR = exports.FETCH_USERS = undefined;
            ...
            return regeneratorRuntime.wrap(function _callee$(_context) {
                while (1) {
                    switch (_context.prev = _context.next) {
                        case 0:
                            _context.next = 2;
                            return _axios2.default.get('http://react-ssr-api.herokuapp.com/users').then(function (response) {
                                dispatch({
                                    type: FETCH_USERS,
                                    payload: response
                                });
